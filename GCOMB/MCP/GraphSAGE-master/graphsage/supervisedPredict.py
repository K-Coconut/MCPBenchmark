...
import graphsage.evaluaterew as evaluaterew
import operator
...
#		total_top_ten_percent = 500
	...
	sup_gs_pred_time_file = FLAGS.train_prefix + "_sup_gs_pred_time_{}_nbs{}.txt".format(num_k, FLAGS.neighborhood_sampling)
	with open(sup_gs_pred_time_file, 'w') as f:
		f.write(str(sup_gs_prediction_time + active_prob_time))
	...
	# get the num_k highest predicted quality nodes greedily

...
public:
    static void InfluenceMaximize(InfGraph &g, const Argument &arg)
    {
        ...
        cout << "Step 1 total RR sets: " << g.hyperGT.size() << endl;
        ...
        INFO("step2 finish");
        cout << "tatal RR sets: " << g.hyperGT.size() << endl;
    }
};
